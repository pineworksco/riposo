...
public class Server {
    ...
    static let session = URLSession(configuration: URLSessionConfiguration.default, delegate: Server.delegate, delegateQueue: nil)
    ...
    public func get(_ path: String? = nil, parameters: [String: Any]? = nil, body: Data? = nil, headers: [String: Any]? = nil, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public func post(_ path: String? = nil, parameters: [String: Any]? = nil, body: Data? = nil, headers: [String: Any]? = nil, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public func patch(_ path: String? = nil, parameters: [String: Any]? = nil, body: Data? = nil, headers: [String: Any]? = nil, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public func put(_ path: String? = nil, parameters: [String: Any]? = nil, body: Data? = nil, headers: [String: Any]? = nil, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public func delete(_ path: String? = nil, parameters: [String: Any]? = nil, body: Data? = nil, headers: [String: Any]? = nil, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public class func request(method: RequestMethod, url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
    ...
    public class func get(url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
        request(method: .get, url: url, parameters: parameters, body: body, headers: headers, completionHandler: completionHandler)
    }
    
    public class func post(url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
        request(method: .post, url: url, parameters: parameters, body: body, headers: headers, completionHandler: completionHandler)
    }
    
    public class func patch(url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
        request(method: .patch, url: url, parameters: parameters, body: body, headers: headers, completionHandler: completionHandler)
    }
    
    public class func put(url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
        request(method: .put, url: url, parameters: parameters, body: body, headers: headers, completionHandler: completionHandler)
    }
    
    public class func delete(url: URL, parameters: [String: Any]?, body: Data?, headers: [String: Any]?, completionHandler: @escaping ResponseHandler = {(_: Response?) -> () in }) {
